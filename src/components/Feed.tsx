    ...
    <>
      <div className="page-content">
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-9 h-9 flex items-center justify-center rounded-full bg-white border border-garden-200 text-garden-600 active:bg-garden-50 transition-colors shadow-sm"
        ...
        <div className="mx-4 mb-4 bg-garden-600 rounded-2xl p-4 text-white">
          <p className="text-xs font-medium opacity-80 mb-1">🌱 Growing near {user.location || 'you'}</p>
